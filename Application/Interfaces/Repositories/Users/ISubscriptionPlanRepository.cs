...
namespace Application.Interfaces.Repositories.Users
{
    public interface ISubscriptionPlanRepository
    {
        ...
        Task<SubscriptionPlanLimit?> GetSubscriptionPlanLimitByIdAsync(Guid subscriptionPlanId);
    ...
    public interface IUserSubscriptionRepository
    {
        ...
        Task<UserSubscriptionUsage?> GetUserSubscriptionUsageByUserSubIdAsync(Guid userSubId);

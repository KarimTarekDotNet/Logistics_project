...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260621074319_FixQueryFiltersAndDecimalPrecision")]
    partial class FixQueryFiltersAndDecimalPrecision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Audits.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Shipments.Invoice", b =>
                {
                    ...
                    b.Property<decimal>("NetShipmentPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Domain.Entities.Shipments.InvoicePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Shipments.ShipmentChargeItem", b =>
                {
                    b.Property<Guid>("ShipmentChargeId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ShipmentItemId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ShipmentChargeId", "ShipmentItemId");

                    b.HasIndex("ShipmentItemId");

                    b.ToTable("ShipmentChargesItems");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Users.Subscriptions.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Users.Subscriptions.SubscriptionPlanLimit", b =>
                {
                    ...
                    b.HasIndex("SubscriptionFeatureId", "LimitCodeSubscription")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.Users.Subscriptions.UserSubscriptionUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserSubscriptionId", "LimitCode", "PeriodStart", "PeriodEnd")
                        .IsUnique();

                    b.ToTable("UserSubscriptionUsages");
                });
            ...
            modelBuilder.Entity("SubscriptionFeatureSubscriptionPlan", b =>
                {
                    ...
                    b.ToTable("SubscriptionFeatureSubscriptionPlan");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Payments.PaymentTransaction", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Users.Subscriptions.UserSubscription", "UserSubscription")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("Domain.Entities.Shipments.ShipmentChargeItem", b =>
                {
                    b.HasOne("Domain.Entities.Shipments.ShipmentCharge", "ShipmentCharge")
                        .WithMany("ChargeItems")
                        .HasForeignKey("ShipmentChargeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Shipments.ShipmentItem", "ShipmentItem")
                        .WithMany("ChargeItems")
                        .HasForeignKey("ShipmentItemId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("ShipmentCharge");
            ...
            modelBuilder.Entity("SubscriptionFeatureSubscriptionPlan", b =>
                {
                    b.HasOne("Domain.Entities.Users.Subscriptions.SubscriptionFeature", null)
                        .WithMany()
                        .HasForeignKey("FeaturesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Users.Subscriptions.SubscriptionPlan", null)
                        .WithMany()
